...
main(int argc, char *argv[])
{
  ...
  2. length + offset - pa_offset, mmaps the ``rest'' of the file into memory (starting from offset)
...
\textbf{Even though we have a section on it, it is highly not recommended to fdopen() anything that doesn't point to an underlying file descriptos}.
...
The basic C library motto is that anything that you can \keyword{fseek} or move to an arbitrary position, you should be able to \keyword{fdopen}.

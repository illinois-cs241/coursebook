...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{ipc/drawings/level_split.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{ipc/drawings/level_split_filled.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=.5\textwidth]{ipc/drawings/three_address_split.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{ipc/drawings/multi_level_split.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\textwidth]{ipc/drawings/multi_level_filled.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.8\textwidth]{ipc/drawings/pipe_process.png}
...
A lot of time, you'll want to use \keyword{pipe2} in combination with dup.
...
If you already have a file descriptor, you can `wrap' it yourself into a FILE pointer using \keyword{fdopen}.
...
As you might have observed with using \keyword{fork}, there is a quirk of the implementation of files and their caches on Ubuntu that will rewind a file descriptor once a file has closed.

...
One final note of caution: \keyword{readdir} is not thread-safe!
...
Use the versatile \keyword{dd} command. For example, the following command copies 1 MiB of data from the file \keyword{/dev/urandom} to the file \keyword{/dev/null}. The data is copied as 1024 blocks of blocksize 1024 bytes.

...
Unintuitively, \keyword{...} does not refer to the `grandparent' directory (parent of the parent).
...
However, there are some nuances. It is possible to have a path called \keyword{a/b/../c/./}.
Since \keyword{..} and \keyword{.} are special entries in directories, this is a valid path that actually refers to \keyword{a/c}.
...
Below is an example that illustrates the simplification of the \keyword{a/b/../c/.} by using \keyword{cd} in a shell to navigate a filesystem.

...
\epigraph{If you think your programs were not working before, wait until they crash ten times as fast}{Bhuvy}
...
In practice, \keyword{pthread\_cancel} is rarely used because it does not allows a thread to clean up after itself (for example, it may have opened some files).

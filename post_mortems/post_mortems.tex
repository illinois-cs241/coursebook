...
Moral of the lesson? Don't have the applications themselves deal with the synchronization. Define a module that handles mutex locking and have module communicate through files, IPC, etc etc.
...
This is problem that hasn't happened yet.

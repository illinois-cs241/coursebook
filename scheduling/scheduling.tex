...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth,alt={Gantt chart of preemptive shortest job first with staggered arrivals. P2 starts first and is preempted when the shorter P1 arrives, then resumes. Later P5 is preempted by the shorter P4, which is in turn preempted by the shorter P3, and the preempted longer jobs finish afterwards.}]{scheduling/drawings/psjf.eps}

...
First, the program places the system call number and its arguments in registers and executes a trap instruction.
The kernel then carries out the call in kernel space, where it can perform privileged operations that user code cannot.

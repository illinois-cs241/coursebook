...
The \gls{Linux kernel} \cite{Love} and the XNU kernel \citet{xnukernel} of which Mac OS X is based on are written in C and have C API - Application Programming Interface.

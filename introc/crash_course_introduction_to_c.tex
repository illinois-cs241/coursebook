...
\begin{enumerate}
    ...
    In C, no two functions in a program can have the same name, because C has no function overloading.
    Two shared libraries can export the same symbol name, though, and the dynamic linker uses the first one it finds.
